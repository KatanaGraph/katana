...
def test_projected(graph):
    ...
    projected_graph = graph.project([graph.node_types.atomic_types["Person"], graph.node_types.atomic_types["Message"]])
    assert projected_graph.num_nodes() == 45 + 3928
    assert projected_graph.num_edges() == 4752
