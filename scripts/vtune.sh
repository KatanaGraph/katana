...
c++filt "$function_out" | perl "$scriptsDir"/report_vtune.pl --in function > "${SUMM_PREFIX}".function."${stamp}".csv

perl "$scriptsDir"/report_vtune.pl --in line > "${SUMM_PREFIX}".line."${stamp}".csv < "$line_out"
