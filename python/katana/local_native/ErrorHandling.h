#ifndef KATANA_PYTHON_KATANA_LOCALNATIVE_ERRORHANDLING_H_
#define KATANA_PYTHON_KATANA_LOCALNATIVE_ERRORHANDLING_H_
...
public:
  PYBIND11_TYPE_CASTER(katana::Result<T>, _("katana::Result<T>"));
