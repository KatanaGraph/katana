...
public:
  ...
  /// Inform this RDG that it's Node Entity Type Id Array is in storage at this location
  ...
  /// Inform this RDG that it's Edge Entity Type Id Array is in storage at this location
  /// without loading it into memory. \param new_type_id_array must exist and be in
  /// the correct directory for this RDG
