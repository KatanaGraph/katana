...
void
galois::runtime::internal::printTrace(std::ostringstream& os) {
...
openIfNot_output() {
  ...
  if (!output_file.is_open()) {
    ...
    char fname[120];
    snprintf(
        fname, sizeof(fname), "output_%s_%d.log", name,
        galois::runtime::getHostID());
...
void
galois::runtime::internal::print_output_impl(std::ostringstream& os) {
