...
// Suuuuuuuuuuuuuuuuuuuuuuuuppppppppppppppppeeeeeeeeeeerrrrrrrrrrrr
// llllllllloooooooooooooonnnnnnnnnnnggggggggggggg
// ccccccccccccoooooooooooommmmmmmmmmmmmmmmeeeeeeeeeeeeeeennnnnnnnnnnnnnntttttttttttt
...
int FileView::Unbind() {
  if (valid_) {
    int err = tsuba::Munmap(map_start_);
    valid_  = false;
    return err;
  }
  return 0;
