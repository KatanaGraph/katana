...
def jaccard_similarity(graph: Graph(is_directed=False, edge_type='map', edge_dtype={'int', 'float'}, edge_has_negative_weights=False), compare_node: NodeID) -> Vector:
    pass
...
def local_clustering(graph: Graph(is_directed=False, edge_type='map', edge_dtype={'int', 'float'}, edge_has_negative_weights=False), prop_name: str='output') -> Vector:
    pass
