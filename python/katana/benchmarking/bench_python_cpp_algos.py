...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--graph", default="GAP-road", choices=GRAPH_CHOICES, help="Graph name (default: %(default)s)",
    )
    parser.add_argument(
        "--application", default="bfs", choices=APP_CHOICES, help="Application to run (default: %(default)s)",
    )
