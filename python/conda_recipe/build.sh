...
export KATANA_CMAKE_ARGS="-DBUILD_LIBGALOIS=OFF -DCMAKE_BUILD_TYPE=Release $CMAKE_CCACHE_OPTION $CMAKE_DOCS_OPTION"
...
if [ -n "$KATANA_DOCS_OUTPUT" ]; then
    ...
    cp -a _skbuild/*/cmake-build/docs/html/* "$KATANA_DOCS_OUTPUT"
fi
